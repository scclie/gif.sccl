...
function saveGif(){BSAVE.disabled=true;BSAVE.textContent='uploading...';var fd=new FormData();fd.append('gif',currentGifBlob,'gif.sccl.cc.gif');fd.append('public',CHP.checked?'true':'false')
